...
ADD_SCENE(nfc, legic_prime_write, LegicPrimeWrite)
ADD_SCENE(nfc, legic_prime_write_success, LegicPrimeWriteSuccess)
ADD_SCENE(nfc, legic_prime_write_fail, LegicPrimeWriteFail)
ADD_SCENE(nfc, legic_prime_set_0x43, LegicPrimeSet43)
ADD_SCENE(nfc, legic_prime_set_0x43_success, LegicPrimeSet43Success)
ADD_SCENE(nfc, legic_prime_set_0x43_fail, LegicPrimeSet43Fail)
ADD_SCENE(nfc, legic_prime_set_0x44, LegicPrimeSet44)
ADD_SCENE(nfc, legic_prime_set_0x44_success, LegicPrimeSet44Success)
ADD_SCENE(nfc, legic_prime_set_0x44_fail, LegicPrimeSet44Fail)
