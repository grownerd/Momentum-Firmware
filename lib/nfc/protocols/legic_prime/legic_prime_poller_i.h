...
#define LEGIC_PRIME_POLLER_MAX_BUFFER_SIZE (1024U)

#define LEGIC_PRIME_POLLER_POLLING_FWT (1000U)

//#define LEGIC_PRIME_POLLER_CMD_POLLING_REQ_CODE  (0x00U)
//#define LEGIC_PRIME_POLLER_CMD_POLLING_RESP_CODE (0x01U)
