...
#define LEGIC_PRIME_SIGNAL_T_SIG                                               \
  (100000000000UL / LEGIC_PRIME_SIGNAL_F_SIG) // == 73.746ns*100, one period
                                              // @ 13.56MHz in ticks
#define LEGIC_PRIME_SIGNAL_F_SUB                                               \
  (212000.0) // Signal subcarrier, used by the tag
#define LEGIC_PRIME_SIGNAL_T_SUB                                               \
  (100000000000UL /                                                            \
   LEGIC_PRIME_SIGNAL_F_SUB) // == 4716.98*100, one period @ 212kHz in ticks
...
static inline void legic_prime_signal_bank_register(LegicPrime_SignalBank bank,
...
LegicPrime_Signal *legic_prime_signal_alloc(const GpioPin *pin) {
  ...
  instance->tx_sequence =
      digital_sequence_alloc(LEGIC_PRIME_SIGNAL_SEQUENCE_SIZE, pin);
